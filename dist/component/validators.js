...
export const runValidator = v.object({
    ...
    status: v.union(v.literal("active"), v.literal("blocked"), v.literal("cancelled"), v.literal("completed"), v.literal("failed_safely")),
    updatedAt: v.string(),
});
...
export const proposalValidator = v.object({
    ...
    status: v.union(v.literal("accepted"), v.literal("conflicted"), v.literal("pending"), v.literal("rejected")),
});
