...
type ComponentTestRegistrar = {
    registerComponent(name: string, schema: SchemaDefinition<GenericSchema, boolean>, modules: Record<string, () => Promise<unknown>>): void;
};
/** Register NodeKit Caseflow in a convex-test host instance. */
export declare function register(testInstance: ComponentTestRegistrar, name?: string): void;
