export const CONTRACT_VERSIONS = Object.freeze({
  ...
  skillBenchmarkInput: "nodekit.skill-benchmark-input/v1",
  skillBenchmarkVerdict: "nodekit.skill-benchmark-verdict/v1",
  skillEvaluatorReceipt: "nodekit.skill-evaluator-receipt/v1",
  skillIntegrityReceipt: "nodekit.skill-integrity-receipt/v1",
